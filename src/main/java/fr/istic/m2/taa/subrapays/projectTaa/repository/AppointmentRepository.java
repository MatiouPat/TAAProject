...
public interface AppointmentRepository extends JpaRepository<Appointment, Long>
{
	...
	@Query("select a from Appointment as a where a.professionnal.firstname=?1 and a.professionnal.lastname=?2")
	...
	@Query("select a from Appointment as a where a.professionnal.firstname=?1 and a.professionnal.lastname=?2 and a.user.firstname=?3 and a.user.lastname=?4")
